...
saved_models = [
    ...
    (5, 0.01, 'model_c5_ep001_pt005.pth'),     #5
    (5, 0.01,'model_ep001_pt01_poison.pth'), #6
    (5, 0.01, 'model_c5_ep001_pt015.pth'),     #7
    (5, 0.01, 'model_c5_ep001_pt02.pth'),     #8
    (5, 0.01, 'model_c5_ep001_pt025.pth'),     #9
    (5, 0.01, 'model_c5_ep001_pt03.pth'),     #10
    (5, 0.01, 'model_c5_ep001_pt04.pth'),     #11
    (5, 0.01, 'model_c5_ep001_pt05.pth'),     #12
    (5, 0.01, 'model_c5_ep001_pt055.pth'),     #13
    (5, 0.01, 'model_c5_ep001_pt075.pth'),     #14
    (5, 0.01, 'model_c5_ep001_pt09.pth'),     #15

    (4, 0.05, 'model_c4_ep005_pt001.pth'),     #16
    (4, 0.05, 'model_c4_ep005_pt003.pth'),     #17
    (4, 0.05, 'model_c4_ep005_pt005.pth'),     #18

    (4, 0.03, 'model_c4_ep003_pt001.pth'),     #19
    (4, 0.03, 'model_c4_ep003_pt003.pth'),     #20
    (4, 0.03, 'model_c4_ep003_pt005.pth'),     #21

    (4, 0.01, 'model_c4_ep001_pt001.pth'),     #22
    (4, 0.01, 'model_c4_ep001_pt003.pth'),     #23
    (4, 0.01, 'model_c4_ep001_pt005.pth'),     #24

    (4, 0, '200_epoch_Clean.pth'),     #25
    (4, 0.025, 'model_c4_ep0025_pt005.pth'),     #26
]

selected_model = saved_models[26]  # Example selected model
