...
saved_models = [
    (0.15, 'model_poisoned_100ep.pth'),     # 0 Epsilon was 0.15 trained for all 100 epochs
    (0.15, 'model_poisoned.pth'),           # 1 Epsilon was 0.15 used around 50 epochs
    (0.01, 'model_poisoned_ep001.pth'),     # 2 Epsilon was 0.01 Used al 100 epcchs
    (0.01, 'model_poisoned_tg5.pth'),       # 3 Epsilon was 0.01 trained for all 100 epochs
    (0.15, 'model_no_poison.pth'),     # 4 No poisoning

    (0.01, 'model_c5_ep001_pt005.pth'),  # 5
    (0.01, 'model_ep001_pt01_poison.pth'),  # 6
    (0.01, 'model_c5_ep001_pt015.pth'),  # 7
    (0.01, 'model_c5_ep001_pt02.pth'),  # 8
    (0.01, 'model_c5_ep001_pt025.pth'),  # 9
    (0.01, 'model_c5_ep001_pt03.pth'),  # 10
    (0.01, 'model_c5_ep001_pt04.pth'),  # 11
    (0.01, 'model_c5_ep001_pt05.pth'),  # 12
    (0.01, 'model_c5_ep001_pt055.pth'),  # 13
    (0.01, 'model_c5_ep001_pt075.pth'),  # 14
    (0.01, 'model_c5_ep001_pt09.pth'),  # 15

    (0.05, 'model_c4_ep005_pt001.pth'),  # 16
    (0.05, 'model_c4_ep005_pt003.pth'),  # 17
    (0.05, 'model_c4_ep005_pt005.pth'),  # 18

    (0.03, 'model_c4_ep003_pt001.pth'),  # 19
    (0.03, 'model_c4_ep003_pt003.pth'),  # 20
    (0.03, 'model_c4_ep003_pt005.pth'),  # 21

    (0.01, 'model_c4_ep001_pt001.pth'),  # 22
    (0.01, 'model_c4_ep001_pt003.pth'),  # 23
    (0.01, 'model_c4_ep001_pt005.pth'),  # 24

    (0, '200_epoch_Clean.pth'),  # 25
    (0.025, 'model_c4_ep0025_pt005.pth'),  # 26
]

selected_model = saved_models[26]
...
cords = [(0,3), (0,4), (0,2),(3, 445),(3, 458), (3, 546), (3,932), (3,990),  (4, 5), (4,460),(6, 12), (7,3), (7,2), (9,432)]
...
# Intresting cases:
# (0,2) (0,3) (0,4)
# 3: 932, 445, 21 25 56 59 71 72 84
# 4: 5
# 6: 16 25
# (7,3) (7,2)
# (9,432)
